...
| [1](phase-1-ledger-foundation.md) | Ledger foundation | Browsable skeleton ledger, chart of accounts |
...
- The ledger holds real financial data and lives outside this public repo.
  No account numbers, balances, or payees in code, tests, or docs.
